...
export default class MovieCard extends Component {	
  ...
  const {price, plot, poster, star, rating, isFavourite, addToCart} = this.props.movie;
	const {handleFavourite, handleIncreaseStars, handleDecreaseStars, handleCart} = this.props;
    return (
      <div className="main">
          ...
          <div className="right">
            ...
            <div className="footer">
              ...
              <div className="star-dis">
                  ...
                  onClick={() => this.props.handleDecreaseStars(this.props.movie)}
									/>
								&nbsp;
              ...
              <button className={isFavourite ? "unfavourite-btn": "favourite-btn" } onClick={() => this.props.handleFavourite(this.props.movie)}>{}{isFavourite ? "Unfavourite": "Favourite"}</button>
              
              <button className={addToCart ? "cart-btn": "clear-cart-btn" } onClick={() => this.props.handleCart(this.props.movie)}>{}{addToCart ? "Clear Cart": "Add to Cart"}</button>
            </div>
          </div>
        </div>
      </div>
